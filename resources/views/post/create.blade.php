    ...
    <div class="md:w-1/2 bg-white p-10 rounded-lg shadow-xl mt-10 md:mt-0">
         ...
         <form action="{{route('post.store')}}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="titulo" name="titulo" type="text" placeholder="Titulo de la publicación" class="border p-3 w-full rounded-lg @error('name')
                    border-red-500                         
                ...
                <div class="mb-5">
                    ...
                    <textarea id="descripcion" name="descripcion" placeholder="Descripción de la publicación" class="border
                     p-3 w-full rounded-lg @error('name') border-red-500                         
